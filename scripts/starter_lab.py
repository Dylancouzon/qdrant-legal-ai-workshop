...
Organizer note, stripped on the way out: this is the file ship.py writes to the
participant tree as lab.py. The root lab.py in this repository is the worked
solution and must never be shipped.
